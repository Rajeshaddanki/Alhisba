...
@interface AccountMyAddsViewController (){
...
@implementation AccountMyAddsViewController
...
- (void)viewDidLoad {
    ...
    tmpTitleLabel.text = Localized(@"My Adds");
    if ([[Utils getLanguage] isEqualToString:KEY_LANGUAGE_AR]) {
...
-(void)clickForInfo:(id)sender{
    ...
    [self showInfo:Localized(@"My Adds") :sender];
}
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.editBtn.layer.cornerRadius = 10.0f;
    cell.editBtn.layer.masksToBounds = true;
    
    cell.repostBtn.layer.cornerRadius = 10.0f;
    cell.repostBtn.layer.masksToBounds = true;

    cell.deleteBtn.layer.cornerRadius = 10.0f;
