//
//  InstantValueEstimatorForRentsViewController.h
//  Alhisba
//
...
@interface InstantValueEstimatorForRentsViewController : BaseViewController
...
@property (weak, nonatomic) IBOutlet UITextField *chooseQualityFld;
...
@property (weak, nonatomic) IBOutlet NSLayoutConstraint *qualityPremiumHeight;
@property (weak, nonatomic) IBOutlet UICollectionView *qualityPremiumCollectionView;

@property (weak, nonatomic) IBOutlet UILabel *optionsLbl;
@property (weak, nonatomic) IBOutlet UILabel *chooseQualityLbl;
