...
@property (weak, nonatomic) IBOutlet UIView *landBackView;
@property (weak, nonatomic) IBOutlet UILabel *priceBackLbl;
...
@property (weak, nonatomic) IBOutlet UILabel *discussLbl;
