//
//  InstantValueEstimatorForRentsViewController.m
//  Alhisba
//
...
@interface InstantValueEstimatorForRentsViewController ()<UIDocumentInteractionControllerDelegate,PopViewControllerDelegate>{
    ...
    NSString *landSizeId,*streetId,*buildingId,*finidhingId,*basementId,*directiontId,*curbtId,*filedLocationId,*noOfFloorsId,*areaId1;
    ...
    NSMutableArray *areaArray,*areasizeId;
    
    NSMutableArray   *qualityPremium,*qualityAray,*qualityIdArray;
    
}

@end

@implementation InstantValueEstimatorForRentsViewController
...
- (void)viewDidLoad {
    ...
    starRatingView.emptyStarImage = [[UIImage imageNamed:@"5starsgray.png"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate];
    starRatingView.filledStarImage = [[UIImage imageNamed:@"5starsgray.png"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate];
    ...
    _optionsLbl.text = Localized(@"Options");
    _chooseQualityLbl.text = Localized(@"Choose Quality");
    ...
    [_landBtn setImage:[UIImage imageNamed:@"radio-on-button.png"] forState:UIControlStateNormal];
    status = @"1";
    [_buildingBtn setImage:[UIImage imageNamed:@"radio-off-button.png"] forState:UIControlStateNormal];
...
//    _sharingBtnHeight.constant = 0;
    ...
    _landSizeLbl.text = Localized(@"Apartment Type");
    _streetLbl.text = Localized(@"No. Of Bathrooms");
    _locationLbl.text = Localized(@"Apartment Size");
    ...
    _selectLandSize.attributedPlaceholder = [[NSAttributedString alloc] initWithString:Localized(@"Select Apartment Type") attributes:@{NSForegroundColorAttributeName: color}];
    
    _chooseQualityFld.attributedPlaceholder = [[NSAttributedString alloc] initWithString:Localized(@"Choose Quality *") attributes:@{NSForegroundColorAttributeName: color}];
    
    _selectStreet.attributedPlaceholder = [[NSAttributedString alloc] initWithString:Localized(@"Select No of Bathrooms") attributes:@{NSForegroundColorAttributeName: color}];
    
    _selectLocationFld.attributedPlaceholder = [[NSAttributedString alloc] initWithString:Localized(@"Select Apartment Size") attributes:@{NSForegroundColorAttributeName: color}];
    ...
    self.navigationItem.title = Localized(@"Instant Value Estimator Rents");
    _instaTitle.text = Localized(@"Instant Value Estimator Rents");
    ...
    //    tmpTitleLabel.text = Localized(@"Instant Value Estimator");
    //    if ([[Utils getLanguage] isEqualToString:KEY_LANGUAGE_AR]) {
    ...
    [self makePostCallForPage:IVE_RENTS withParams:@{} withRequestCode:100];
...
-(void)clickForInfo:(id)sender{
    ...
    [self showInfo:Localized(@"Instant Value Estimator") :sender];
}
...
-(void)clearToStart{
    _advancedSpecImage.image = [UIImage imageNamed:@"add.png"];
    _advancedBtn.selected = NO;
    status = @"1";
   // _allSpecsView.hidden = YES;
    _allspecHeight.constant = 0;
...
-(void)parseResult:(id)result withCode:(int)reqeustCode{
    ...
    if (reqeustCode == 1) {
        ...
        [ActionSheetStringPicker showPickerWithTitle:Localized(@"Select Area")
                                    ...
                                    initialSelection:0
                                           doneBlock:^(ActionSheetStringPicker *picker, NSInteger selectedIndex, id selectedValue) {
                                               ...
                                               _locationCheckHeight.constant = (locationArray.count/2 *55)+(locationArray.count%2 *55);
                                               //
        ...
        if ([[Utils getLanguage] isEqualToString:KEY_LANGUAGE_AR]) {
            ...
            locationArray = [[result valueForKey:@"options"][0] valueForKey:@"value_arabic"];
            
            locationSpecArray =  [[result valueForKey:@"specs_groups1"][0] valueForKey:@"value_arabic"];
            
            plotSpecArray =  [[result valueForKey:@"specs_groups2"][0] valueForKey:@"value_arabic"];
            
            facingArray =   [[result valueForKey:@"specs_groups3"][0] valueForKey:@"value_arabic"];
            
        qualityPremium =   [[result valueForKey:@"quality"][0] valueForKey:@"value_arabic"];
...
//            }
            ...
            locationArray = [[result valueForKey:@"options"][0] valueForKey:@"value_english"];
            
            locationSpecArray =  [[result valueForKey:@"specs_groups1"][0] valueForKey:@"value_english"];
            
            plotSpecArray =  [[result valueForKey:@"specs_groups2"][0] valueForKey:@"value_english"];
            
            facingArray =   [[result valueForKey:@"specs_groups3"][0] valueForKey:@"value_english"];
            
            qualityPremium =   [[result valueForKey:@"quality"][0] valueForKey:@"value_english"];
...
//            }
        ...
        locationArrayMulti = [[result valueForKey:@"options"][0] valueForKey:@"id"];
        
        locationSpecArrayMulti = [[result valueForKey:@"specs_groups1"][0] valueForKey:@"id"];
        
        plotSpecArrayMulti = [[result valueForKey:@"specs_groups2"][0]  valueForKey:@"id"];
        
        facingArrayMulti = [[result valueForKey:@"specs_groups2"][0]  valueForKey:@"id"];
 ...
 //       curbCheckArray = [[result valueForKey:@"crub_check"] valueForKey:@"multiplication_factor"];
   ...
   //         _qualityPremiumHeight.constant = (qualityPremium.count/2 *55)+(qualityPremium.count%2 *55);

            _plotSpecHeight.constant = (plotSpecArray.count/2 *58)+(plotSpecArray.count%2 *58);
            _specCollectionViewHeight.constant = (locationSpecArray.count/2 *55)+(locationSpecArray.count%2 *55);
            _facingHeight.constant = (facingArray.count/2 *50)+(facingArray.count%2 *50);
            _sharedCollectionViewHeight.constant =(locationSpecArray.count/2 *50)+(locationSpecArray.count%2 *50);
            parseRe = @"parse";
  ...
  //      [_qualityPremiumCollectionView reloadData];
...
- (NSInteger)collectionView:(UICollectionView *)collectionView numberOfItemsInSection:(NSInteger)section {
    ...
    if (collectionView == _locationcollectionView) {
        ...
        return locationSpecArray.count;
    } else if (collectionView == _qualityPremiumCollectionView){
        return qualityPremium.count;
    }
    return 0;
}
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (collectionView == _locationcollectionView) {
        ...
        cell.titleLbl.text = [locationSpecArray objectAtIndex:indexPath.row];
        
        [cell.checkBtn setImage:[UIImage imageNamed:@"checkoff.png"] forState:UIControlStateNormal];
        
        cell.titleLbl.textColor = [UIColor colorWithRed:80.0f/255.0f green:99.0f/255.0f blue:139.0f/255.0f alpha:1.0f];
        
        if ([crackArray1 containsObject:[NSString stringWithFormat:@"%li",(long)indexPath.row]])
        {
            [cell.checkBtn setImage:[UIImage imageNamed:@"checkon.png"] forState:UIControlStateNormal];
        ...
        cell.selectedBtn = ^{
            ...
            cell.titleLbl.textColor = [UIColor colorWithRed:19.0f/255.0f green:40.0f/255.0f blue:83.0f/255.0f alpha:1.0f];
        ...
        [cell1.titleLlb setTextAlignment:NSTextAlignmentCenter];
        
        //        [cell1.checkBoxBtn setImage:[UIImage imageNamed:@"boxuncheck.png"] forState:UIControlStateNormal];
        
        cell1.checkBoxBtn.layer.borderWidth = 1.0f;
        cell1.checkBoxBtn.layer.borderColor = [UIColor colorWithRed:221.0f/255.0f green:222.0f/255.0f blue:226.0f/255.0f alpha:1.0].CGColor;
        cell1.checkBoxBtn.layer.backgroundColor = [UIColor whiteColor].CGColor;
        cell1.titleLlb.textColor = [UIColor colorWithRed:80.0f/255.0f green:99.0f/255.0f blue:139.0f/255.0f alpha:1.0];
        cell1.checkBoxBtn.layer.cornerRadius =15.0f;
        [self cellButonShadowClear:cell1.checkBoxBtn];
        
        //       cell1.checkBoxBtn.layer.masksToBounds = YES;
        
        //        cell1.layer.borderWidth = 2.0f;
        //        cell1.layer.borderColor = [UIColor lightGrayColor].CGColor;
        //        cell1.layer.cornerRadius =15.0f;
        ...
        if ([locationSpecsArray1 containsObject:[NSString stringWithFormat:@"%li",(long)indexPath.row]])
        {
            ...
            //  cell1.checkBoxBtn.layer.borderWidth = 2.0f;
            // cell1.checkBoxBtn.layer.borderColor = [UIColor colorWithRed:247.0f/255.0f green:189.0f/255.0f blue:95.0f/255.0f alpha:1.0].CGColor;
            //cell1.checkBoxBtn.layer.backgroundColor = [UIColor colorWithRed:247.0f/255.0f green:189.0f/255.0f blue:95.0f/255.0f alpha:1.0].CGColor;
            cell1.checkBoxBtn.layer.borderWidth = 0.0f;
            cell1.checkBoxBtn.layer.backgroundColor = [UIColor colorWithRed:211.0f/255.0f green:174.0f/255.0f blue:41.0f/255.0f alpha:1.0].CGColor;
            
            [self cellButonShadow:cell1.checkBoxBtn];
            
            
            cell1.titleLlb.textColor = [UIColor whiteColor];
            cell1.checkBoxBtn.layer.cornerRadius =15.0f;
            //          cell1.checkBoxBtn.layer.masksToBounds = YES;
            //            cell1.layer.borderWidth = 2.0f;
            //            cell1.layer.borderColor = [UIColor colorWithRed:247.0f/255.0f green:189.0f/255.0f blue:95.0f/255.0f alpha:1.0].CGColor;
            //            cell1.layer.cornerRadius =15.0f;
            //            cell1.layer.masksToBounds = YES;
        ...
        QualityPremiumCollectionViewCell *cell1 = [self.qualityPremiumCollectionView dequeueReusableCellWithReuseIdentifier:@"QualityPremiumCollectionViewCell" forIndexPath:indexPath];
        
        cell1.titleLlb.text = [qualityPremium objectAtIndex:indexPath.row];
        ...
        if ([qualityPremium containsObject:[NSString stringWithFormat:@"%li",(long)indexPath.row]])
        {
            //            [cell1.checkBoxBtn setImage:[UIImage imageNamed:@"boxchecked.png"] forState:UIControlStateNormal];
            //  cell1.checkBoxBtn.layer.borderWidth = 2.0f;
            // cell1.checkBoxBtn.layer.borderColor = [UIColor colorWithRed:247.0f/255.0f green:189.0f/255.0f blue:95.0f/255.0f alpha:1.0].CGColor;
        ...
        cell1.selectedBtn =  ^{
            ...
            if ([locationSpecsArray1 containsObject:[NSString stringWithFormat:@"%li",(long)indexPath.row]])
            {
                ...
                [locationSpecTitleContained removeObject:[qualityPremium objectAtIndex:indexPath.row]];
                
                [locationSpecsContained removeObject:[qualityPremium objectAtIndex:indexPath.row]];
            ...
            else
            {
                ...
                [locationSpecTitleContained addObject:[qualityPremium objectAtIndex:indexPath.row]];
                
                [locationSpecsContained addObject:[qualityPremium objectAtIndex:indexPath.row]];
        ...
        cell.checkBoxBtn.layer.borderColor = [UIColor lightGrayColor].CGColor;
        cell.checkBoxBtn.layer.borderWidth = 1.0f;
        cell.checkBoxBtn.layer.backgroundColor = [UIColor whiteColor].CGColor;
        cell.titleLlb.textColor = [UIColor colorWithRed:80.0f/255.0f green:99.0f/255.0f blue:139.0f/255.0f alpha:1.0];
        cell.checkBoxBtn.layer.cornerRadius =15.0f;
        cell.checkBoxBtn.layer.masksToBounds = YES;
        
        [self cellButonShadowClear:cell.checkBoxBtn];
        ...
        if ([plotSpesArray1 containsObject:[NSString stringWithFormat:@"%li",(long)indexPath.row]])
        {
            ...
            cell.checkBoxBtn.layer.borderWidth = 0.0f;
            cell.checkBoxBtn.layer.backgroundColor = [UIColor colorWithRed:211.0f/255.0f green:174.0f/255.0f blue:41.0f/255.0f alpha:1.0].CGColor;
            cell.titleLlb.textColor = [UIColor whiteColor];
            //            cell.titleLlb.textColor = [UIColor whiteColor];
            [self cellButonShadow:cell.checkBoxBtn];
...
- (CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout *)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (collectionView == _locationSpecCollectionView) {
        
        //return CGSizeMake((collectionView.frame.size.width)/2-10,50);
        return CGSizeMake((_locationSpecCollectionView.frame.size.width)/2-10,50);
        ...
        return CGSizeMake((collectionView.frame.size.width)/2-10,45);
    }
    else{
        //return CGSizeMake((collectionView.frame.size.width)/2-10,50);
        return CGSizeMake((collectionView.frame.size.width)/2-10,50);
...
- (IBAction)selectAreabtnTapped:(id)sender {
    ...
    if ([[Utils getLanguage] isEqualToString:KEY_LANGUAGE_AR]) {
        ...
        areaArray = [[resultArray1 valueForKey:@"areas"][0] valueForKey:@"value_arabic"];
    }
    else{
        areaArray = [[resultArray1 valueForKey:@"areas"][0] valueForKey:@"value_english"];
    }
        
        areasizeId = [[resultArray1 valueForKey:@"areas"][0] valueForKey:@"area_id"];
        ...
        if(areaArray.count>0){
            [ActionSheetStringPicker showPickerWithTitle:Localized(@"Select Size")
                                ...
                                _selectAreaFld.text=[NSString stringWithFormat:@"%@",[areaArray objectAtIndex:selectedIndex]];
                                                   
                        areaId1 = [NSString stringWithFormat:@"%@",[areasizeId objectAtIndex:selectedIndex]];
                                                   
                    if ([_selectAreaFld.text isEqualToString:@""] || [_selectLandSize.text isEqualToString:@""] || [_selectLocationFld.text isEqualToString:@""] || [_selectStreet.text isEqualToString:@""]) {
...
- (IBAction)selectLandSizeBtnTapped:(id)sender {
        ...
        fldType = @"Select Apartment Type";
        
        NSLog(@"result Array %@",resultArray1);
        
        landSizeArray = [[resultArray1 valueForKey:@"types"][0] valueForKey:@"value_english"];
        sizeIdarray = [[resultArray1 valueForKey:@"types"][0] valueForKey:@"id"];
...
- (IBAction)selectStreetBtnTapped:(id)sender {
        ...
        fldType = @"Select Bathroom";
        
        if ([[Utils getLanguage] isEqualToString:KEY_LANGUAGE_AR]) {
            streetArray = [[resultArray1 valueForKey:@"bathrooms"][0] valueForKey:@"value_arabic"];
        }
        else{
            streetArray = [[resultArray1 valueForKey:@"bathrooms"][0] valueForKey:@"value_english"];
        }
        
        streetIdarray = [[resultArray1 valueForKey:@"bathrooms"][0] valueForKey:@"id"];
        streetMulti = [[resultArray1 valueForKey:@"bathrooms"][0] valueForKey:@"id"];
        
        [ActionSheetStringPicker showPickerWithTitle:Localized(@"Select Bathroom")
                                                rows:streetArray
                                    initialSelection:0
                                           doneBlock:^(ActionSheetStringPicker *picker, NSInteger selectedIndex, id selectedValue) {
...
- (IBAction)advancedSpecBtnTapped:(id)sender {
        ...
        if (_advancedBtn.selected == YES)
        {
            ...
            if ([status isEqualToString:@"1"]) {
                ...
                _buildingSpecHeight.constant = 480;
                ...
                _plotSpecHeight.constant = (plotSpecArray.count/2 *58)+(plotSpecArray.count%2 *58);
                _specCollectionViewHeight.constant = (locationSpecArray.count/2 *55)+(locationSpecArray.count%2 *55);
                _facingHeight.constant = (facingArray.count/2 *55)+(facingArray.count%2 *55);
                _sharedCollectionViewHeight.constant =(curbCheckArray.count/2 *55)+(curbCheckArray.count%2 *55);
        ...
        {
            _advancedSpecImage.image = [UIImage imageNamed:@"minus.png"];
            ...
            if ([status isEqualToString:@"1"]) {
                ...
                _buildingSpecHeight.constant = 460;
                _buildingSpecView.hidden = NO;
                _allSpecsView.hidden = NO;
                //  _allspecHeight.constant = 950;
                
                _allspecTopHeight.constant = 90;
...
- (IBAction)locationBtnTapped:(id)sender {
        ...
        fldType = @"Select Apartment Size";
        
        if ([[Utils getLanguage] isEqualToString:KEY_LANGUAGE_AR]) {
            filedLocationArray = [[resultArray1 valueForKey:@"sizes"][0] valueForKey:@"value_arabic"];
        }
        else{
            filedLocationArray = [[resultArray1 valueForKey:@"sizes"][0] valueForKey:@"value_english"];
        }
        
        filedLocationIdArray = [[resultArray1 valueForKey:@"sizes"][0] valueForKey:@"id"];
        locationMulti = [[resultArray1 valueForKey:@"sizes"] valueForKey:@"id"][0];
...
- (IBAction)buildingTapped:(id)sender {
    ...
    if ([self.selectAreaFld.text length] == 0) {
        ...
        {
            [_buildingBtn setImage:[UIImage imageNamed:@"radio-on-button.png"] forState:UIControlStateNormal];
            [_landBtn setImage:[UIImage imageNamed:@"radio-off-button.png"] forState:UIControlStateNormal];
            status = @"2";
            //_buildingSpecView.backgroundColor    = [UIColor redColor];
            
            if ([advancSpeString isEqualToString:@"SELECTED"]) {
                
                _buildingSpecHeight.constant = 500;
                _buildingSpecView.hidden = NO;
                //                _allSpecsView.hidden = YES;
                _allspecHeight.constant = 0;
                _sharingBtnHeight.constant = 0;
    ...
    if ([self.selectAreaFld.text length] == 0) {
        ...
        else
        {
            ...
            if (_allspecHeight.constant > 700) {
                ...
                _shareBtnTop.constant = _plotSpecHeight.constant+_facingHeight.constant +_specCollectionViewHeight.constant+215;
            }
...
-(void)textFldBoarders{
    ...
    _chooseQualityFld.layer.borderColor = [UIColor whiteColor].CGColor;
    //    _selectAreaFld.layer.borderWidth = 2.0f;
    _chooseQualityFld.layer.cornerRadius = 10.0f;
...
-(void)paddingFlds{
    ...
    if ([[Utils getLanguage] isEqualToString:KEY_LANGUAGE_AR]) {
        ...
        _chooseQualityFld.rightView = paddingView10;
        _chooseQualityFld.rightViewMode = UITextFieldViewModeAlways;
        ...
        _chooseQualityFld.leftView = paddingView10;
        _chooseQualityFld.leftViewMode = UITextFieldViewModeAlways;
...
-(void)viewWillAppear:(BOOL)animated{
    ...
    _locationSpecLbl.text = Localized(@"Specifications Group1");
    _plotSpecLbl.text = Localized(@"Specifications Group2");
    _facingSpecLbl.text = Localized(@"Specifications Group3");
    [_calculateBtn setTitle:Localized(@"Calculate") forState:UIControlStateNormal];
    _directioNLbl.text = Localized(@"Direction");
    _curbLbl.text = Localized(@"Curb");
...
-(void)cellButonShadow:(UIButton *)btn{
    
    UIBezierPath *shadowPath = [UIBezierPath bezierPathWithRect:btn.bounds];
    btn.layer.masksToBounds = NO;
    btn.layer.shadowColor = [UIColor colorWithRed:211.0f/255.0f green:174.0f/255.0f blue:41.0f/255.0f alpha:1.0].CGColor;
    btn.layer.shadowOffset = CGSizeMake(0.0f, 2.0f);
    btn.layer.shadowOpacity = 0.3f;
    btn.layer.shadowPath = shadowPath.CGPath;
}

-(void)cellButonShadowClear:(UIButton *)btn{
    
    UIBezierPath *shadowPath = [UIBezierPath bezierPathWithRect:btn.bounds];
    btn.layer.masksToBounds = NO;
    btn.layer.shadowColor = [UIColor clearColor].CGColor;
    btn.layer.shadowOffset = CGSizeMake(0.0f, 3.0f);
    btn.layer.shadowOpacity = 0.1f;
    btn.layer.shadowPath = shadowPath.CGPath;
}
...
- (IBAction)chooseQualityBtnTapped:(id)sender {
    

        fldType = @"Select Quality";
        
        if ([[Utils getLanguage] isEqualToString:KEY_LANGUAGE_AR]) {
            qualityAray = [[resultArray1 valueForKey:@"quality"][0] valueForKey:@"value_arabic"];
        }
        else{
            qualityAray = [[resultArray1 valueForKey:@"quality"][0] valueForKey:@"value_english"];
        }
        
        qualityIdArray = [[resultArray1 valueForKey:@"quality"][0] valueForKey:@"id"];
        ...
        [ActionSheetStringPicker showPickerWithTitle:Localized(@"Select Quality")
                ...
                _chooseQualityFld.text=[NSString stringWithFormat:@"%@",[qualityAray objectAtIndex:selectedIndex]];
