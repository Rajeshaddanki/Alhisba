...
{
    UIImage* image = [UIImage imageNamed:@"likelined.png"];
    ...
    CGContextClipToMask(context, newrect, [UIImage imageNamed:@"like.png"].CGImage);
    ...
    if (self.userRating < 0.2f) {
       ...
       // [[UIColor colorWithRed:212.0f/255.0f green:175.0f/255.0f blue:42.0f/255.0f alpha:1.0f] setFill];
    }
